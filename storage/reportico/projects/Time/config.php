...
ReporticoApp::setConfig('project_password',"peeksafety");

// Project Title used at the top of menus
ReporticoApp::setConfig('project_title',"Time Reports");
...
ReporticoApp::setConfig('db_type',"existingconnection");
...
ReporticoApp::setConfig('db_user',"N/A");
ReporticoApp::setConfig('db_password',"N/A");
ReporticoApp::setConfig('db_host',"N/A");
ReporticoApp::setConfig('db_database',"N/A");
}
else
{
...
ReporticoApp::setConfig('db_server',"N/A");
ReporticoApp::setConfig('db_protocol',"N/A");
...
ReporticoApp::setConfig('output_sections_tcpdf', array (
        ...
        'page-header-block' => array (
                array ( 
                        'content' => '{REPORT_TITLE}', 
                        'styles' => 'border-width: 0px 0px 1px 0px; margin: 0px 0px 0px 0px; border-color: #000000; font-size: 18; border-style: solid;padding:0px 0px 0px 0px; background-color: #000; color: #fff; margin-left: 0%;margin-bottom: 20px;text-align:center' 
                      ),
                ),
