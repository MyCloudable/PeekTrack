<x-page-template bodyClass='g-sidenav-show  bg-gray-200 dark-version'>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle="Estimating"></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
        <div class="container-fluid py-4">
			...
			<div class="table-responsive">
              <table class="table table-flush" id="datatable-basic">
				...
				@if ($job->approved == 4)
				<tr>
				<td class="text-sm font-weight-normal"><input type="button" value="Open" class="btn btn-warning" onclick="window.location.href='/jobs/{{ $job->link }}/view';"/></td>
