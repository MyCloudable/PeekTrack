    ...
    if (leavePage) {
        ...
        function addItem(id, desc, est, unit) {
            if (parseInt(id.substring(3, 8)) < 10000) {
				...
				+ 
				'<td><input type="hidden" name="new_phase_item_complete[]" value="0"><input class="form-control-sm" style="background-color: white;color: black !important;" type="checkbox" onchange="this.previousElementSibling.value = this.checked ? 1 : 0;" placeholder="Phase Complete"></td>' 
				+ 
				'<td></td>' 
				+
				'<td><input type="button" class="btn-warning" value="Delete Row" onclick="SomeDeleteRowFunction(this)"></td>';
